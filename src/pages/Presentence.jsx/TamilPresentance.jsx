...
import verbsTamil from "../data/verbsTamilScript.json"; // ✅ default import

export default function VerbHindiList() {
  const [search, setSearch] = useState("");

  const filteredVerbs = verbsTamil.filter(
    (item) =>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      <h1 className="text-3xl font-bold mb-6 text-center text-green-700">
        English–Hindi Verb Conjugations
      </h1>
        ...
        {filteredVerbs.length > 0 ? (
          filteredVerbs.map((item, idx) => (
            ...
            >
              ...
              <p className="text-sm text-gray-500 mb-3">{item.meaning}</p>
